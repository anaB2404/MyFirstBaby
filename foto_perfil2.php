...
?>
				...
				<form action="php/upload_bebe 2.php" method="post" enctype="multipart/form-data">
					<p class="fileinput-new" style=" margin-left:35%; font-family:'MotiraItalic'; font-size:3em; font-weight:bolder;">Selecione uma imagem para o seu perfil </p>
					<div class="fileinput fileinput-new text-center" data-provides="fileinput">
						<div class="fileinput-new thumbnail img-raised" style="width:12vw; height:30%; margin-left:44%;">
							<img src="http://style.anu.edu.au/_anu/4/images/placeholders/person_8x10.png" alt="...">
						</div>
					<div>
						<div style=" margin-left:39%; font-size:16px; font-weight:bolder;">
							<input type="file" name="imagem"/>
							<div><input style="margin-top:20px; margin-right:63.5%;" type="submit"/></div>
						</div>
						</div>
					</div>
					<br/>
