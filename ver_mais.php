		...
		<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
			...
			<div class="container" style="background-color:white; margin-top:5%; box-shadow: 0 29px 32px -20px rgba(0,0,0,0.5), 0 4px 11px -3px rgba(0,0,0,0.25); border-radius:10px;">
				<div class="row" style="margin-left:1%; margin-right:1%;">
					...
					<div class="header">
						...
						<div class="profile">
							<img class="photo-author icon" src="imagens/<?php echo $dados['foto_perfil']; ?>"/>
							 <h5 class="nome" style="font-size:17px; text-align:justify;">por <?php echo  $dados["nome"];?></h5>
                                <p class="dat" style="font-size:17px;"><?php $d = explode(" ", $dados["data_hora"]);
                        $data = explode("-", $d[0]);
                        echo "$data[2]/$data[1]/$data[0] às $d[1]";
                        ?></p>
												<p class="dat" style="font-size:15px;"><?php if ($idtipousuario == 1) {?> Administrador <?php }else {?> Usúario  <?php } ?></p>
						</div>
					...
					<div class="col-xs-12 text" style="font-family:Summer;">
						<div class="col-xs-10 text" style="text-align:justify;">
						<img style="width:80%; height:50%; margin-left:7%; margin-bottom:5%; border:1px solid;" src="imagens/<?php echo $dados['imagem'];?>"/>
