...
$result_postagens = "SELECT * FROM postagem WHERE id_fk_categoria = 2 ORDER BY id_postagem DESC limit $incio, $quantidade_pg";
$resultado_postagem = mysqli_query($conexao, $result_postagens);
			   ...
			   <h2 style="font-weight:bolder;margin-bottom:3%;"><span class="ion-minus"></span>Novidades<span class="ion-minus"></span></h2>
				...
				<div class="row">
                     <div class="col-md-9 col-lg-offset-2 text-center">
						<p style="font-size:25px;">Saiba mais sobre como cuidar da alimentação do seu bebê! </p><br>
					 </div>
				...
				<?php 	while($dados = mysqli_fetch_assoc($resultado_postagem)){?>
						...
						<div class="col-md-3 col-xs-12">
							 <div class="blog-column">
								...
								<a class="btn btn-blog pull-right marginBottom10" style="color:rgba(69,90,194,.8); font-weight:bolder"; href="ver_mais_semlog.php?id=<?php echo $dados['id_postagem'];?>">Ver mais</a>
							</div>
						</div>
