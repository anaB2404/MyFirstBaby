...
<html lang="pt=br">
    ...
    <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
		...
		<!--Container sobre-->
		<div class="row" style=" background:#F0F8FF;">
		...
		<div style="background-color:#fff; margin-top:1%;">
			<div style= "background-color: #ffb6c1;">
				<div style="text-align:center; background-color: #ffb6c1;" class="sobrenos">Quem somos</div>
					<div style="text-align:center;"> O site foi criado por seis pessoas, com base no nosso trabalho de conclusão de curso.</div> <br>
						<div class="row">
		...
		<!-- CONTATO-->
            ...
            <div class="row"></div>
			  ...
			  <form action="enviar.php" method="post">
               ...
               <div class="col-md-8 col-md-offset-1" style="margin-top:-2%;"> <textarea style=" resize:none; width:106%;"class="form-control" id="comments" name="comments" placeholder="Comentario" rows="5" required></textarea><br></div>
                  <div0
