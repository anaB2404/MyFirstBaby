             ...
             <div class="container-fluid posicao banner" style="position:relative">
                                   <form  action="php/update.php" method="get">
                                     ...
                                     <div class="form-group shadow-textarea">
                                       <br>
                                       <textarea class="form-control z-depth-1" id="exampleFormControlTextarea6" rows="3" placeholder="Escreva sua publicação aqui" name="conteudo"><?php echo $dados['conteudo']; ?></textarea>
                                       <ul>
